...
tanggallengkap = namahari[hari] + ", " +tanggal + " " + namabulan[bulan] + " " + tahun;
    ...
    <!-- WARNING: Respond.js doesn't work if you view the page via file:// -->
      ...
      <body class="skin-black">
		...
		<b>Selamat Datang di PERPUSIN.ID (Perpustakaan Berbasis Website) Untuk Login Admin silahkan klik Icon User atau klik <a href="login.html">disini</a></b>
          </div>
            </div>
                    ...
                    <div class="twt-area">
                        <form class="form-horizontal style-form" style="margin-top: 20px;" action="insert-pengunjung.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <textarea rows="4" name="saran" id="saran" class="form-control" placeholder="Saran Anda untuk PERPUSIN.ID" cols="25"></textarea>
                                  <!--<span class="help-block">A block of help text that breaks onto a new line and may extend beyond one line.</span>-->
                              </div>
                          </div>
                          <div class="form-group">
...
<!-- Data Total Pengunjung -->                        
              ...
              <!-- row end -->
                ...
                <div class="footer-main">
                    Copyright &copy <a href="http://www.sarjanakomedi.com" target="_blank">PERPUSIN.ID</a> 2022
                </div>
            </aside><!-- /.right-side -->
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">PERPUSIN.ID</h4>
      </div>
      <div class="modal-body">
      PERPUSIN.ID adalah aplikasi perpustakaan bebasis website yang responsif
      <table>
      <tr>
      <td>No Telepon</td> <td>:</td> <td>0895635387022</td>
      </tr>
      <br />
      <tr>
      <td>E-mail</td><td>:</td> <td><a href="muhammadaqsal96@gmail.com">muhammadaqsal96@gmail.com</a> | <a href="mailto:rsabyl@gmail.com">rsabyl@gmail.com</a></td>
      </tr> 
      <br />
       </table>
      </div>
